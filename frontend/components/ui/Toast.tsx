...
export default function Toast() {
  ...
  const borders = { ok: "border-l-emerald-500", err: "border-l-red-500", info: "border-l-violet-500" };

  return (
    <div
      className={`fixed bottom-6 right-6 z-[999] flex items-center gap-2.5 px-4 py-3 rounded-lg
        bg-surface border border-violet-800/50 border-l-4 ${borders[toast.type]}
